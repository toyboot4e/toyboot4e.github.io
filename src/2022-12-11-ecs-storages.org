...
# #+ATTR_HTML: :width 601px
# #+caption: big-array.png
[[./img/toecs/big-array.png]]

# #+BEGIN_QUOTE
# 本当はコンポーネントを縦列にすると、データベースとの対応が取れて良い比喩になるのですが……
# #+END_QUOTE
...
[[./img/toecs/archetype-storage.png]]
...
[[./img/toecs/groups.png]]

これは =Entity= を削除したり、 =Entity= にコンポーネントを追加・削除する際のグループの更新処理で実現されます:

[[./img/toecs/group-sync.png]]

[[./img/toecs/group-unsync.png]]
...
[[./img/toecs/free-slot.png]]

初期状態からデータを追加した後は:

[[./img/toecs/free-slot-insert.png]]

初期状態からデータを削除した後は:

[[./img/toecs/free-slot-remove.png]]
