...
`;function D(e,o,a){let t=e.createShader(o);return t?(e.shaderSource(t,a),e.compileShader(t),e.getShaderParameter(t,e.COMPILE_STATUS)?t:(console.warn("disco: shader compile failed:",e.getShaderInfoLog(t)),e.deleteShader(t),null)):null}function F(e){let o=D(e,e.VERTEX_SHADER,j),a=D(e,e.FRAGMENT_SHADER,Q);if(!o||!a)return null;let t=e.createProgram();return t?(e.attachShader(t,o),e.attachShader(t,a),e.linkProgram(t),e.getProgramParameter(t,e.LINK_STATUS)?t:(console.warn("disco: program link failed:",e.getProgramInfoLog(t)),null)):null}var G="toybeam-disco";function J(){try{return localStorage.getItem(G)!=="off"}catch(e){return!0}}function Z(e){try{let o=e.getExtension("WEBGL_debug_renderer_info");if(!o)return!1;let a=String(e.getParameter(o.UNMASKED_RENDERER_WEBGL)||"").toLowerCase();return/swiftshader|llvmpipe|softpipe|software|basic render|microsoft basic|mesa offscreen/.test(a)}catch(o){return!1}}function v(e){return window.matchMedia?window.matchMedia(e):null}function B(e,o){e&&(e.addEventListener?e.addEventListener("change",o):e.addListener(o))}function $(){let e=document.documentElement.getAttribute("data-theme");if(e==="dark")return!0;if(e==="light")return!1;let o=v("(prefers-color-scheme: dark)");return!!(o&&o.matches)}function N(){let e=document.getElementById("disco-canvas");if(!e)return;function o(){document.documentElement.classList.remove("disco-on","disco-static"),e.remove();let r=document.querySelector(".disco-bg-light");r&&r.remove();let n=document.getElementById("disco-toggle");n&&n.remove()}let a={alpha:!0,antialias:!1,depth:!1,stencil:!1,premultipliedAlpha:!1,powerPreference:"low-power"},t=e.getContext("webgl",a)||e.getContext("experimental-webgl",a);if(!t){o();return}if(Z(t)){o();return}let i=F(t);if(!i){o();return}let U=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,U),t.bufferData(t.ARRAY_BUFFER,new Float32Array([-1,-1,3,-1,-1,3]),t.STATIC_DRAW);let _=t.getAttribLocation(i,"a_pos");t.enableVertexAttribArray(_),t.vertexAttribPointer(_,2,t.FLOAT,!1,0,0),t.useProgram(i);let W=t.getUniformLocation(i,"u_res"),Y=t.getUniformLocation(i,"u_time"),q=t.getUniformLocation(i,"u_ballOnly"),y=v("(pointer: coarse)"),A=!!(y&&y.matches),K=A?1:1.5,z=A?.7:1;function R(){let r=Math.min(window.devicePixelRatio||1,K)*z*L,n=Math.max(1,Math.round(e.clientWidth*r)),w=Math.max(1,Math.round(e.clientHeight*r));(e.width!==n||e.height!==w)&&(e.width=n,e.height=w),t.viewport(0,0,n,w)}let g=v("(prefers-reduced-motion: reduce)"),l=0,d=!1,u=0,p=!1,f=J(),b=1e3/30,L=1,S=!1,s=0,P=0,m=0,x=0;function k(){S=!0,h(),o()}function V(){L>.34?L*=.6:k()}function C(r,n){R(),t.uniform2f(W,e.width,e.height),t.uniform1f(Y,r),t.uniform1f(q,n?1:0),t.drawArrays(t.TRIANGLES,0,3),p||(p=!0,e.style.opacity="1")}function O(r){if(!d||(u||(u=r),l=window.requestAnimationFrame(O),s&&r-s<b-1))return;let n=s?r-s:b;if(s=r,++P>5){if(n>150){if(++x>=3){k();return}}else x=0;if(n>b*2){if(++m>=10){m=0,V();return}}else m=0}C((r-u)/1e3,!1)}function H(){return!!(g&&g.matches)}let E=0;function T(){document.documentElement.classList.add("disco-static"),!E&&(E=window.setTimeout(()=>{E=0,C(9,!0)},0))}function X(){if(!d){if(H()){T();return}document.documentElement.classList.remove("disco-static"),d=!0,u=0,s=0,P=0,m=0,l=window.requestAnimationFrame(O)}}function h(){d=!1,l&&window.cancelAnimationFrame(l),l=0}function c(){if(S)return;let r=$()&&f;document.documentElement.classList.toggle("disco-on",r),r&&!document.hidden?X():(h(),e.style.opacity="0",p=!1)}let I=document.getElementById("disco-toggle");function M(){I&&I.setAttribute("aria-pressed",f?"true":"false")}M(),window.toggleDisco=function(){f=!f;try{localStorage.setItem(G,f?"on":"off")}catch(r){}M(),c()},new MutationObserver(c).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}),B(v("(prefers-color-scheme: dark)"),c),B(g,()=>{h(),c()}),document.addEventListener("visibilitychange",c),window.addEventListener("resize",()=>{d?R():document.documentElement.classList.contains("disco-on")&&T()}),e.addEventListener("webglcontextlost",r=>{r.preventDefault(),h()},!1),e.addEventListener("webglcontextrestored",()=>{i=F(t),i&&(t.useProgram(i),c())},!1),c()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",N):N();})();
