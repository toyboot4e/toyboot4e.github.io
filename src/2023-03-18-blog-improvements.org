...
[[./img/2023-03-sitemap-1.webp]]

変更後、日付を =<a>= タグから分離しました:

#+attr_html: :width 407px
[[./img/2023-03-sitemap-2.webp]]
...
#+BEGIN_SRC ditaa :file ./img/2023-03-ditaa.webp :cmdline -r
+--------------+
| Hello World! |
+--------------+
#+END_SRC

[[./img/2023-03-ditaa.webp]]

**** [[https://orgmode.org/worg/org-contrib/babel/languages/ob-doc-plantuml.html][plantuml]]

#+begin_src plantuml :file ./img/2023-03-plantuml.webp
Bob ->> Alice : Hello World!
#+end_src

[[./img//2023-03-plantuml.webp]]

**** [[https://graphviz.org/][graphviz]]

#+BEGIN_SRC dot :file ./img/2023-03-graphvi.webp
strict graph {
  a -- b
  a -- b
  b -- a [color=blue]
