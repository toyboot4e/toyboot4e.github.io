...
#+BEGIN_EXPORT html
<figure>
  <video src="./img/2024-06-23-ahc034.mp4" preload="auto" controls
         aria-label="AHC 034 の提出解の可視化 (音声なし)"></video>
  <figcaption>AHC 034 の提出解の可視化。グリッド上をパスに沿って移動しながら、各マスの +-100 の値を 0 に均していく様子 (音声なし)。</figcaption>
</figure>
#+END_EXPORT
...
[[./img/2024-06-23-floor_sum_1.webp]]
...
[[./img/2024-06-23-floor_sum_4.webp]]
